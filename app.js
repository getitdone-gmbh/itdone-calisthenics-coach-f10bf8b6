...
function renderPlan() {
  ...
  document.getElementById('planTitle').textContent = `Dein Plan: ${d.name}`;
  document.getElementById('planLevelBadge').textContent = `Level: ${LEVEL_LABELS[level]}`;
  document.getElementById('planIntro').textContent = levelInfo.summary;
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('restartBtn').addEventListener('click', () => {
    state = { disciplineKey: null, answers: {} };
    goToStep('discipline');
  });
});
